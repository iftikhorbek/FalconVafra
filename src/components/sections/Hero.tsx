...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" id="home">
      ...
      {/* Scroll Indicator - Centered within hero section */}
      <div className="absolute bottom-8 left-0 right-0 z-20 fade-in-up delay-600 pointer-events-none">
        <div className="flex flex-col items-center justify-center space-y-2 mx-auto w-fit">
          <span className="text-white/60 text-sm text-center whitespace-nowrap">{t.hero.scrollText}</span>
